...
public class StatisticsFristChoiceReportTest
{
    ReportDAO firstChoiceReport;
    HashMap<String, Object> input;

    @Before
    public void initialize()
    {
        firstChoiceReport = ReportDAOFactory.getBasicReportDAO();
    }

    public StatisticsFristChoiceReportTest(HashMap<String, Object> input)
    {
        this.input = input;
    }
    ...
    {
        assertNotNull(firstChoiceReport);
    }

    @Test
    public void testDBConnection()
    {
        assertNotNull(firstChoiceReport.DBConnection());
    }
    ...
    {
        List<String> column;
        column = firstChoiceReport.getUserTestTableColumns(null);
    ...
    public void testGetdataOfBasicReport()
    {
        ...
        firstChoiceReport.DBConnection();
        ReportLogger.LOGGER.info((String)input.get("TestName"));
        results = firstChoiceReport.getUserTestResult(input);

...
CREATE TABLE FBJ_TEST (
		...
		,FK_TestNameID VARCHAR(20) NOT NULL REFERENCES FBJ_TEST_NAME(PK_TestNameID)
		,Updt DATETIME Default GETDATE()
	);
...
CREATE TABLE FBJ_TEST_NAME_ITEM
    (
    PK_TestNameItemID int NOT NULL PRIMARY KEY,
...
Print 'Create FBJ_TEST_NAME Table.' + CHAR(10);
    ...
    (
    PK_TestNameID int NOT NULL PRIMARY KEY,
    Name varchar(20) NOT NULL
    );
